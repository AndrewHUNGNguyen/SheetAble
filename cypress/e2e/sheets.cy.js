describe('Sheets Page', () => {
  ...
  it('Verifying UI elements of Sheets Page with no sheets added', () => {
  ...
  it('Checks if Upload Dialog box appearance when clicking Upload Button', () => {
  ...
  it('Tests uploading on Sheets Page with no sheets', () => {
